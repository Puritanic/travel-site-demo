...
new _scrollReveal2.default((0, _jquery2.default)('.testimonial'), '75%');
...
var FixedHeader = function () {
    function FixedHeader() {
        ...
        this.siteHeader = (0, _jquery2.default)('.site-header');
        this.headerTriggerElement = (0, _jquery2.default)('.btn--orange');
    ...
    _createClass(FixedHeader, [{
        ...
        key: 'createHederWaypoint',
        value: function createHederWaypoint() {
            var that = this;
            new Waypoint({
            ...
            this.pageSections.each(function () {
                ...
                new Waypoint({
                    ...
                    handler: function handler(direction) {
                        if (direction == 'down') {
                            var matchingDataLink = currentPageSection.getAttribute('data-link');
                            that.headerLinks.removeClass('active-link');
                            (0, _jquery2.default)(matchingDataLink).addClass('active-link');
                        }
                    },
                    offset: '15%'
                });
